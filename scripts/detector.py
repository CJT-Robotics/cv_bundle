...
from cv_msg.msg import CV_msg, Image_Detection, BBox
...
class ImageProcessor:
    def __init__(self):
        ...
        try:
            package_path = rospack.get_path('cv_image_detector')
    ...
    def image_callback(self, msg):
        try:
            ...
            bundle_msg.image_detections = image_detections
...
def main():
    ...
    try:
        ...
        print("Shutting down image detector node.")
